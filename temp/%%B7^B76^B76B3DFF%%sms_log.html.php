<?php /* Smarty version 2.6.6, created on 2012-01-09 11:49:01
         compiled from C:/wamp/www/nm_tx/pw/sms_log.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'C:/wamp/www/nm_tx/pw/sms_log.html', 41, false),array('modifier', 'stripslashes', 'C:/wamp/www/nm_tx/pw/sms_log.html', 89, false),)), $this); ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <!---------------------------------------->    
      ...
      <tr align="center">
        <td bgcolor="#558ED5" style="height:25px"><font size="2" color="white"><b>Planned Work SMS Log</b></font></td>
      </tr>      
	  <tr>
      ...
      <tr>
      	<td>
      		<table width="100%" cellspacing="1" cellpadding="5" border="0">
      			<tr bgcolor="#7C93F4">
      				<td align="center" width="10%"><b>Execution Date</b></td>
      				<td align="center" colspan="3"><b>Message</b></td>
      				<td align="center" width="20%"><b>Sent To</b></td>
      				<td align="center"><b>Sent By</b></td>
      				<td align="center" width="10%"><b>Sent @</b></td>
      			</tr>
...
?>
      			  <tr <?php if ($this->_tpl_vars['key']%2 == 0): ?> bgcolor="#EEEEEE" <?php else: ?> bgcolor="#EEFFEE" <?php endif; ?>>
                      ...
                      <td colspan="3">
                             <?php echo ((is_array($_tmp=$this->_tpl_vars['obj']->message)) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>

                      </td>
                      <td width="20%">
                             <?php echo $this->_tpl_vars['obj']->recipient; ?>

                      </td>
                      <td>
                             <?php echo $this->_tpl_vars['obj']->sent_by; ?>

                      </td>
                      <td width="14%">
                             <?php echo $this->_tpl_vars['obj']->sent_time; ?>
